...
| **Column Name** | 15 chars, letters & digits, single spaces allowed | Fits board column headers; empty = column hidden. |
...
### Frontend
In addition to backend stripping, the frontend applies additional layers of protection:
